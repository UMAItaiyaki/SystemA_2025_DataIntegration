...
namespace Batch.Common
{
    ...
    public class SFTPUtil
    {
        ...
        public SFTPUtil()
        {
            ...
            PassPhrase = ConfigurationManager.AppSettings["SHOP_CODE"];
        }

        /// <summary>
        /// 商品マスタファイル取得
        /// </summary>
        public void GetItemMasterFiles()
        {
            // ダウンロード元（送信）フォルダ
            ...
            try
            {
                ...
                using (var sftp = new SftpClient(SFTPServer, PassPhrase, keyFile))
                {
                    // SFTPサーバへ接続
                    sftp.Connect();
