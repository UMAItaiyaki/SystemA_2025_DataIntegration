...
namespace Management
{
    public partial class Transmission : Form
    {
        ...
        private void search_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (sender == search_btn)
                {
                    ...
                    //分類
                    if (send_checkbox.Checked) category.Add(0);
                    if (reception_checkbox.Checked) category.Add(1);
        ...
        private void clear_btn_Click(object sender, EventArgs e)
        {
            ...
            foreach (CheckBox cbx in new CheckBox[] { reception_checkbox, send_checkbox, cbxProceed, cbxRetry, cbxError })
            {
                cbx.Checked = true;
            }
        }

        /// <summary>「更新」ボタン処理</summary>>
        ...
        private string checkInput()
        {
            ...
            //分類:未選択チェック
            checkFlg = false;
            foreach (CheckBox cbx in new CheckBox[] { send_checkbox, reception_checkbox })
            {
                if (cbx.Checked == true)
                {
                    checkFlg = true;
